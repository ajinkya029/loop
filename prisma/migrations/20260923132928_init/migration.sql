...
-- CreateEnum
CREATE TYPE "Channel" AS ENUM ('SUPPORT_TICKET', 'APP_STORE_REVIEW', 'NPS_SURVEY', 'CSAT_SURVEY', 'SALES_CALL_NOTE', 'SOCIAL_MENTION', 'CSV_IMPORT', 'MANUAL');
...
CREATE TABLE "themes" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "color" TEXT NOT NULL DEFAULT '#6153e8',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "workspaceId" TEXT NOT NULL,
